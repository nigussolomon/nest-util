...
- [nest-notify setup guide](./nest-notify/README.md)
...
7. Add `NestNotifyModule.forRoot(...)` for FCM push + SMTP email notifications.
8. Apply global interceptors and filters as shown in [demo-api setup](./demo-api/README.md).
